...
| evf_add [simp]: "eval_flat_stack \<Pi> (i1 # i2 # \<sigma>, FAdd # \<pi>, s, \<omega>) ((i2 + i1) # \<sigma>, \<pi>, s, \<omega>)"
...
| evf_and [simp]: "eval_flat_stack \<Pi> (i1 # i2 # \<sigma>, FAnd # \<pi>, s, \<omega>) 
    (unboolify (boolify i2 \<and> boolify i1) # \<sigma>, \<pi>, s, \<omega>)"
| evf_or [simp]: "eval_flat_stack \<Pi> (i1 # i2 # \<sigma>, FOr # \<pi>, s, \<omega>) 
    (unboolify (boolify i2 \<or> boolify i1) # \<sigma>, \<pi>, s, \<omega>)"
